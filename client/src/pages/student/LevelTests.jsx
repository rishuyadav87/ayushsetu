                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-3">
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {l.passed && <span className="text-xs bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full flex items-center gap-1"><CheckCircle size={12} /> Passed</span>}
                      ...
                      return (
                        <div key={t.id} className="border border-gray-100 rounded-lg p-4 flex flex-col">
                          ...
                          <div className="flex flex-wrap gap-3 text-xs text-gray-500 mt-2">
                            ...
                            {t.proctored && <span className="flex items-center gap-1 text-indigo-600"><ShieldCheck size={12} /> Proctored</span>}
                            {t.source === 'AI' && <span className="flex items-center gap-1 text-purple-600"><Sparkles size={12} /> AI</span>}
                          </div>
                          {t.attempts > 0 && <div className={`text-xs mt-2 ${passed ? 'text-indigo-700' : 'text-orange-700'}`}>Best {t.bestPercentage}% · {t.attempts} attempt(s)</div>}
                          <button
                            disabled={t.locked}
