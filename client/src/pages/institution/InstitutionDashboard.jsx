      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Total Students" value={stats?.totalStudents ?? 0} icon={<Users size={24} />} colorClass="text-blue-600 bg-blue-100" />
            <StatCard title="Avg Readiness Score" value={stats?.overallReadiness ?? 0} icon={<Activity size={24} />} colorClass="text-green-600 bg-green-100" />
            <StatCard title="Opportunities" value={stats?.totalOpportunities ?? 0} icon={<Briefcase size={24} />} colorClass="text-purple-600 bg-purple-100" />
            <StatCard title="Assessments" value={stats?.totalAssessments ?? 0} icon={<CheckCircle size={24} />} colorClass="text-orange-600 bg-orange-100" />
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <div className="text-center py-8 text-gray-500">
              <p className="text-sm">No recent placements to show yet.</p>
            </div>
          </div>
        </div>
      </div>
