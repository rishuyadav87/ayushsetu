      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard title="Total Users" value={stats?.totalUsers || "14,000"} icon={<Users size={24} />} colorClass="text-indigo-600 bg-indigo-100" />
            ...
            <StatCard title="Active Opportunities" value={stats?.activeOpportunities || "342"} icon={<Briefcase size={24} />} colorClass="text-indigo-600 bg-indigo-100" />
