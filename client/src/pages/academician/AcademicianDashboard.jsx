  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Active Mentees" value="15" icon={<Users size={24} />} colorClass="text-blue-600 bg-blue-100" />
        <StatCard title="Research Projects" value="3" icon={<BookOpen size={24} />} colorClass="text-purple-600 bg-purple-100" />
        <StatCard title="FDPs Completed" value="4" icon={<GraduationCap size={24} />} colorClass="text-green-600 bg-green-100" />
        <StatCard title="Endorsements Given" value="42" icon={<FileText size={24} />} colorClass="text-orange-600 bg-orange-100" />
      </div>
