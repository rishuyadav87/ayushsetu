  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Active Postings" value="5" icon={<Briefcase size={24} />} colorClass="text-blue-600 bg-blue-100" />
        <StatCard title="Total Applications" value="142" icon={<FileText size={24} />} colorClass="text-purple-600 bg-purple-100" trend="up" trendValue="12%" />
        <StatCard title="Shortlisted" value="28" icon={<Users size={24} />} colorClass="text-orange-600 bg-orange-100" />
        <StatCard title="Hired" value="6" icon={<CheckCircle size={24} />} colorClass="text-green-600 bg-green-100" />
      </div>
